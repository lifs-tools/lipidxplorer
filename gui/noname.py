...
class MyFrame7 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"LX2_dev", pos = wx.DefaultPosition, size = wx.Size( 743,717 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_dirPicker1 = wx.DirPickerCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		bSizer13.Add( self.m_dirPicker1, 1, wx.ALL, 5 )
		...
		bSizer131.Add( self.m_filePicker1, 1, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer21.Add( self.m_textCtrl9, 0, wx.TOP|wx.BOTTOM, 5 )
		...
		self.m_staticText23 = wx.StaticText( self.m_panel5, wx.ID_ANY, u"LX2", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button6 = wx.Button( self.m_panel5, wx.ID_ANY, u"Positive mode", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer21.Add( self.m_button6, 1, wx.ALL|wx.EXPAND, 5 )

		self.m_button7 = wx.Button( self.m_panel5, wx.ID_ANY, u"Negavite mode", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer21.Add( self.m_button7, 1, wx.ALL|wx.EXPAND, 5 )

		self.m_button8 = wx.Button( self.m_panel5, wx.ID_ANY, u"Drop Fuzzy", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_button8.SetToolTip( u"Initial scans oftenhave invalid data, discard these scans?" )

		bSizer21.Add( self.m_button8, 1, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_textCtrl91 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer211.Add( self.m_textCtrl91, 0, wx.TOP|wx.BOTTOM, 5 )

		self.m_textCtrl101 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer211.Add( self.m_textCtrl101, 0, wx.TOP|wx.BOTTOM, 5 )
		...
		bSizer211.Add( self.m_textCtrl15, 0, wx.TOP|wx.BOTTOM, 5 )

		self.m_textCtrl16 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer211.Add( self.m_textCtrl16, 0, wx.TOP|wx.BOTTOM, 5 )
		...
		self.m_staticText27 = wx.StaticText( self.m_panel5, wx.ID_ANY, u"LX2", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer25.Add( self.m_staticText27, 0, wx.ALL, 5 )
		...
		bSizer25.Add( self.m_textCtrl17, 1, wx.TOP|wx.BOTTOM|wx.RIGHT|wx.EXPAND, 5 )
		...
		bSizer25.Add( self.m_textCtrl18, 1, wx.ALL|wx.EXPAND, 5 )


		bSizer18.Add( bSizer25, 0, wx.EXPAND, 5 )
		...
		bSizer18.Add( bSizer26, 1, wx.EXPAND, 5 )
		...
		self.m_slider1 = wx.Slider( self.m_panel5, wx.ID_ANY, 70, 0, 100, wx.DefaultPosition, wx.DefaultSize, wx.SL_HORIZONTAL )
		bSizer212.Add( self.m_slider1, 0, wx.ALL, 5 )

		self.m_textCtrl43 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, u"70", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer212.Add( self.m_textCtrl43, 0, wx.ALL, 5 )
		...
		self.m_button19 = wx.Button( self.m_panel5, wx.ID_ANY, u"Select Blank", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer212.Add( self.m_button19, 0, wx.ALL, 5 )

		self.m_button191 = wx.Button( self.m_panel5, wx.ID_ANY, u"QC Spectra", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer212.Add( self.m_button191, 0, wx.ALL, 5 )


		bSizer201.Add( bSizer212, 1, wx.EXPAND, 5 )
		...
		self.m_slider11 = wx.Slider( self.m_panel5, wx.ID_ANY, 0, 0, 100, wx.DefaultPosition, wx.DefaultSize, wx.SL_HORIZONTAL )
		bSizer2121.Add( self.m_slider11, 0, wx.ALL, 5 )

		self.m_textCtrl431 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, u"0", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2121.Add( self.m_textCtrl431, 0, wx.ALL, 5 )
		...
		self.m_textCtrl46 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2121.Add( self.m_textCtrl46, 0, wx.ALL, 5 )


		bSizer201.Add( bSizer2121, 1, wx.EXPAND, 5 )
		...
		self.m_textCtrl911 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2111.Add( self.m_textCtrl911, 0, wx.TOP|wx.BOTTOM, 5 )

		m_choice1Choices = [ u"Absolute", u"Relative" ]
		self.m_choice1 = wx.Choice( self.m_panel5, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice1Choices, 0 )
		self.m_choice1.SetSelection( 0 )
		bSizer2111.Add( self.m_choice1, 0, wx.ALL, 5 )
		...
		self.m_textCtrl151 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2111.Add( self.m_textCtrl151, 0, wx.TOP|wx.BOTTOM, 5 )

		m_choice11Choices = [ u"Absolute", u"Relative" ]
		self.m_choice11 = wx.Choice( self.m_panel5, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice11Choices, 0 )
		self.m_choice11.SetSelection( 0 )
		bSizer2111.Add( self.m_choice11, 0, wx.ALL, 5 )
		...
		bSizer201.Add( bSizer2111, 1, wx.EXPAND, 5 )


		bSizer181.Add( bSizer201, 1, wx.EXPAND, 5 )
		...
		self.m_staticText102 = wx.StaticText( self.m_panel5, wx.ID_ANY, u"MS2 precursor grouping tolerance", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText102.Wrap( -1 )

		bSizer58.Add( self.m_staticText102, 0, wx.ALL, 5 )

		self.m_textCtrl60 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer58.Add( self.m_textCtrl60, 0, wx.ALL, 5 )
		...
		self.m_textCtrl61 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer59.Add( self.m_textCtrl61, 0, wx.ALL, 5 )
		...
		self.m_textCtrl62 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer59.Add( self.m_textCtrl62, 0, wx.ALL, 5 )
		...
		bSizer12.Add( bSizer56, 1, wx.EXPAND, 5 )
		...
		self.m_textCtrl611 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer591.Add( self.m_textCtrl611, 0, wx.ALL, 5 )
		...
		self.m_textCtrl621 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer591.Add( self.m_textCtrl621, 0, wx.ALL, 5 )

		self.m_staticText1071 = wx.StaticText( self.m_panel5, wx.ID_ANY, u"MS2 FWHM", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText1071.Wrap( -1 )

		bSizer591.Add( self.m_staticText1071, 0, wx.ALL, 5 )

		self.m_button211 = wx.Button( self.m_panel5, wx.ID_ANY, u"Suggest Resdolution", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer62.Add( bSizer591, 1, wx.EXPAND, 5 )
		...
		self.m_textCtrl6111 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer5911.Add( self.m_textCtrl6111, 0, wx.ALL, 5 )
		...
		self.m_textCtrl6211 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer5911.Add( self.m_textCtrl6211, 0, wx.ALL, 5 )
		...
		bSizer62.Add( bSizer5911, 1, wx.EXPAND, 5 )
		...
		self.m_textCtrl61111 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer59111.Add( self.m_textCtrl61111, 0, wx.ALL, 5 )

		m_choice5Choices = [ u"PPM", u"Da" ]
		self.m_choice5 = wx.Choice( self.m_panel5, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice5Choices, 0 )
		self.m_choice5.SetSelection( 0 )
		bSizer59111.Add( self.m_choice5, 0, wx.ALL, 5 )
		...
		self.m_textCtrl62111 = wx.TextCtrl( self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer59111.Add( self.m_textCtrl62111, 0, wx.ALL, 5 )

		m_choice51Choices = [ u"PPM", u"Da" ]
		self.m_choice51 = wx.Choice( self.m_panel5, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice51Choices, 0 )
		self.m_choice51.SetSelection( 0 )
		bSizer59111.Add( self.m_choice51, 0, wx.ALL, 5 )
		...
		bSizer12.Add( bSizer60, 1, wx.EXPAND, 5 )
