...
class MyWizard1 ( wx.adv.Wizard ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText1 = wx.StaticText( self.m_wizPage1, wx.ID_ANY, u"Folder with Input files", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText1.Wrap( -1 )

		bSizer1.Add( self.m_staticText1, 0, wx.ALL, 5 )

		self.m_dirPicker_input = wx.DirPickerCtrl( self.m_wizPage1, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		...
		self.m_staticText3 = wx.StaticText( self.m_wizPage2, wx.ID_ANY, u"Input files", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3.Wrap( -1 )

		bSizer3.Add( self.m_staticText3, 0, wx.ALL, 5 )

		m_checkList1_inputfilesChoices = []
		self.m_checkList1_inputfiles = wx.CheckListBox( self.m_wizPage2, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_checkList1_inputfilesChoices, 0 )
		...
		self.m_staticText2 = wx.StaticText( self.m_wizPage3, wx.ID_ANY, u"Root MFQL folder", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2.Wrap( -1 )

		bSizer2.Add( self.m_staticText2, 0, wx.ALL, 5 )

		self.m_dirPicker_rootMFQLdir = wx.DirPickerCtrl( self.m_wizPage3, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		...
		self.m_staticText4 = wx.StaticText( self.m_wizPage4, wx.ID_ANY, u"MFQL files", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4.Wrap( -1 )

		bSizer4.Add( self.m_staticText4, 0, wx.ALL, 5 )

		m_checkList2_mfqlfilesChoices = []
		self.m_checkList2_mfqlfiles = wx.CheckListBox( self.m_wizPage4, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_checkList2_mfqlfilesChoices, 0 )
		...
		self.Autofill_Parameters_label = wx.StaticText( self.m_wizPage5, wx.ID_ANY, u"Autofill Parameters", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.Autofill_Parameters_label.Wrap( -1 )

		bSizer5.Add( self.Autofill_Parameters_label, 0, wx.ALL, 5 )

		self.m_propertyGridManager_props = pg.PropertyGridManager(self.m_wizPage5, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.propgrid.PGMAN_DEFAULT_STYLE)
