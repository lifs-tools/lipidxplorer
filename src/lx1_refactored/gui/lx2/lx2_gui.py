...
class Lx2_gui(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_panel5.SetToolTip(
            "Blanks and Quality controls are not used to calculate signal stability"
        )
        ...
        self.spectra_folder = wx.DirPickerCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            "Select a folder",
        ...
        self.m_staticText41 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Select Project or Settings file*",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.ini_file = wx.FilePickerCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            "Select a file",
            "LX Project file (*.lxp)|*.lxp|\nConfiguration file (*.ini)|*.ini|\nAll files (*.*)|*.*",
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.pos_mode_button = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "Positive mode",
            wx.DefaultPosition,
        ...
        self.neg_mode_buttom = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "Negavite mode",
            wx.DefaultPosition,
        ...
        self.drop_fuzzy_button = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "Drop Fuzzy",
            wx.DefaultPosition,
        ...
        self.drop_fuzzy_button.SetToolTip(
            "Initial scans often have invalid data, discard these scans?"
        )
        ...
        self.mass_range_ms1_1 = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.mass_range_ms1_2 = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.mass_range_ms2_1 = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.mass_range_ms2_2 = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        bSizer25.Add(
            self.text_include, 1, wx.TOP | wx.BOTTOM | wx.RIGHT | wx.EXPAND, 5
        )
        ...
        self.m_staticText122 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Repetition Rate within Spectra",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.rep_rate_slider = wx.Slider(
            self.m_panel5,
            wx.ID_ANY,
            70,
            0,
        ...
        self.m_staticText132 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "%",
            wx.DefaultPosition,
        ...
        self.m_staticText76 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "|",
            wx.DefaultPosition,
        ...
        self.select_blank_btn = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "Select Blank",
            wx.DefaultPosition,
        ...
        self.qc_spectra_button = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "QC Spectra",
            wx.DefaultPosition,
        ...
        self.m_staticText1221 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Found in % of spectra",
            wx.DefaultPosition,
        ...
        self.found_in_slider = wx.Slider(
            self.m_panel5,
            wx.ID_ANY,
            0,
            0,
        ...
        self.found_int_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            "0",
            wx.DefaultPosition,
        ...
        self.m_staticText74.SetToolTip("|")
        ...
        self.m_staticText1211 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Signal Intensity",
            wx.DefaultPosition,
        ...
        self.signla_inty_ms1_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        ms1_sig_inty_typeChoices = ["Absolute", "Relative"]
        self.ms1_sig_inty_type = wx.Choice(
            self.m_panel5,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            ms1_sig_inty_typeChoices,
            0,
        )
        ...
        self.m_staticText12111 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Signal Intensity",
            wx.DefaultPosition,
        ...
        self.signla_inty_ms2_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        ms2_sig_inty_typeChoices = ["Absolute", "Relative"]
        self.ms2_sig_inty_type = wx.Choice(
            self.m_panel5,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            ms2_sig_inty_typeChoices,
            0,
        )
        ...
        self.m_staticText100 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Selection Window and Calibration",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.prec_group_tol = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.m_staticText103 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Da.",
            wx.DefaultPosition,
        ...
        self.m_button20 = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "Estimate grouping tolerance",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.cal_masses_ms1 = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.cal_masses_ms1.SetToolTip("comma seperated values")

        bSizer59.Add(self.cal_masses_ms1, 0, wx.ALL, 5)

        self.m_staticText105 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS1",
            wx.DefaultPosition,
        ...
        self.cal_masses_ms2 = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.cal_masses_ms2.SetToolTip(
            "will use MS! calubration masses if none are provieded"
        )

        bSizer59.Add(self.cal_masses_ms2, 0, wx.ALL, 5)

        self.m_staticText107 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS2",
            wx.DefaultPosition,
        ...
        self.m_staticText1041 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Resolution of lowest mass",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.ms1_low_mass_res_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.m_staticText1051 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS1",
            wx.DefaultPosition,
        ...
        self.m_staticText1061 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "|",
            wx.DefaultPosition,
        ...
        self.ms2_low_mass_res_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.m_staticText1071 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS2",
            wx.DefaultPosition,
        ...
        self.m_button211.SetToolTip(
            "NOTE: this is not the actual resolution; its the average distance between peaks acrosss scans"
        )

        bSizer591.Add(self.m_button211, 0, wx.ALL, 5)

        self.m_staticText125 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "FWHM",
            wx.DefaultPosition,
        ...
        self.m_staticText10411 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Resolution gradient",
            wx.DefaultPosition,
        ...
        self.ms1_res_gradient_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.m_staticText10511 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS1",
            wx.DefaultPosition,
        ...
        self.m_staticText10611 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "|",
            wx.DefaultPosition,
        ...
        self.ms2_res_gradient_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.m_staticText10711 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS2",
            wx.DefaultPosition,
        ...
        self.m_button31 = wx.Button(
            self.m_panel5,
            wx.ID_ANY,
            "See estimated Resolution",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        self.m_button31.SetToolTip(
            "NOTE: this is not the actual resolution; its the average distance between peaks within a scan"
        )
        ...
        self.m_staticText104111 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "Tolerance",
            wx.DefaultPosition,
        ...
        self.ms1_tolerance_txt = wx.TextCtrl(
            self.m_panel5,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        ms1_tolerance_type_choiseChoices = ["PPM", "Da"]
        self.ms1_tolerance_type_choise = wx.Choice(
            self.m_panel5,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            ms1_tolerance_type_choiseChoices,
            0,
        )
        self.ms1_tolerance_type_choise.SetSelection(1)
        bSizer59111.Add(self.ms1_tolerance_type_choise, 0, wx.ALL, 5)

        self.m_staticText105111 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS1",
            wx.DefaultPosition,
        ...
        self.m_staticText106111 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "|",
            wx.DefaultPosition,
        ...
        ms2_tol_type_choiseChoices = ["PPM", "Da"]
        self.ms2_tol_type_choise = wx.Choice(
            self.m_panel5,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            ms2_tol_type_choiseChoices,
            0,
        )
        self.ms2_tol_type_choise.SetSelection(1)
        bSizer59111.Add(self.ms2_tol_type_choise, 0, wx.ALL, 5)

        self.m_staticText107111 = wx.StaticText(
            self.m_panel5,
            wx.ID_ANY,
            "MS2",
            wx.DefaultPosition,
        ...
        self.m_notebook1.AddPage(self.m_panel5, "Import Settings", False)
        ...
        # Connect Events
        self.spectra_folder.Bind(
            wx.EVT_DIRPICKER_CHANGED, self.spectra_dir_changed
        )
