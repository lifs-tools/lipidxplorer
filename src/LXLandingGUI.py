...
class LandingFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.m_lx2_button = wx.Button(
            self, wx.ID_ANY, "LX2", wx.DefaultPosition, wx.DefaultSize, 0
        )
        b_sizer.Add(self.m_lx2_button, 0, wx.ALL, 5)

        self.m_lx1_buttonn = wx.Button(
            self, wx.ID_ANY, "LX1", wx.DefaultPosition, wx.DefaultSize, 0
        )
        b_sizer.Add(self.m_lx1_buttonn, 0, wx.ALL, 5)

        self.m_lx1_refactor = wx.Button(
            self,
            wx.ID_ANY,
            "LX1 (Refactored)",
            wx.DefaultPosition,
        ...
        self.m_lx_tools = wx.Button(
            self, wx.ID_ANY, "Tools", wx.DefaultPosition, wx.DefaultSize, 0
        )
