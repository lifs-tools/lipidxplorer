...
class SetDebugFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.checkBox_IsotopicCorrection_MSMS = wx.CheckBox(
        ...
        self.checkBox_removeIsotopes = wx.CheckBox(
            self,
            -1,
            "Do not remove the isotopes (from Type II correction) from the result",
        )
        self.checkBox_removeIsotopes.SetToolTip(
            wx.ToolTip("do not remove the isotopes from the result")
        )
        ...
        self.checkBox_isotopesInMasterscan = wx.CheckBox(
            self, -1, "Show isotopic correction in MasterScan dump"
        )
        self.checkBox_isotopesInMasterscan.SetToolTip(
            wx.ToolTip("Show isotopic correction in MasterScan dump")
        )
        ...
        self.checkBox_monoisotopicCorrection = wx.CheckBox(
            self, -1, "Don't do Type I isotopic correction."
        )
        self.checkBox_monoisotopicCorrection.SetToolTip(
            wx.ToolTip("Don't do Type I isotopic correction.")
        )
        ...
        self.checkBox_relativeIntensity = wx.CheckBox(
            self, -1, "Print relative intensities in dump."
        )
        self.checkBox_relativeIntensity.SetToolTip(
            wx.ToolTip("Print relative intensities.")
        )
        ...
        self.checkBox_MemoryLog.SetToolTip(
            wx.ToolTip(
        ...
        self.Bind(
            wx.EVT_CHECKBOX,
            self.OnCheckIsotopesInMasterScan,
            self.checkBox_isotopesInMasterscan,
        )
        self.Bind(
            wx.EVT_CHECKBOX,
            self.OnCheckMonoisotopicCorrection,
            self.checkBox_monoisotopicCorrection,
        )
        self.Bind(
            wx.EVT_CHECKBOX,
            self.OnCheckRelativeIntensity,
            self.checkBox_relativeIntensity,
        )
...
class SetAlignmentFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.radioBox_ms_alignment = wx.RadioBox(
            self,
            -1,
            "MS alignment method",
            wx.DefaultPosition,
        ...
        self.radioBox_ms_alignment.SetToolTip(
            wx.ToolTip("choose the preferred alignment method")
        )
        self.radioBox_ms_alignment.SetSelection(0)

        ### radio box for ms/ms alignment method ###
        self.radioBox_msms_alignment = wx.RadioBox(
            self,
            -1,
            "MS/MS alignment method",
            wx.DefaultPosition,
            wx.DefaultSize,
            self.alignmentMethodsMSMS,
            1,
        ...
        self.radioBox_scanAveraging = wx.RadioBox(
            self,
            -1,
            "Scan averaging method",
            wx.DefaultPosition,
            wx.DefaultSize,
            self.scanAveragingMethods,
            1,
        ...
        self.radioBox_scanAveraging.SetToolTip(
            wx.ToolTip("choose the preferred scan averaging method")
        )
    ...
    def OnEvtRadioBoxMSMS(self, evt):
        self.parent.lpdxOptions[
            "alignmentMethodMSMS"
        ] = self.alignmentMethodsMSMS_intern[evt.GetInt()]
...
class SetOutputOptionFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.checkBox_correctIntensities = wx.CheckBox(
            self, -1, "correct intensities: "
        )
        ...
        self.sizer_v_correctIntensities.Add(
            self.label_precursor, 0, wx.LEFT | wx.CENTER, 5
        )
        self.sizer_v_correctIntensities.Add(
            self.text_ctrl_precursor, 0, wx.LEFT | wx.CENTER, 5
        )
        self.sizer_v_correctIntensities.Add(
            self.label_fragment, 0, wx.LEFT | wx.CENTER, 5
        )
        self.sizer_v_correctIntensities.Add(
            self.text_ctrl_fragment, 0, wx.LEFT | wx.CENTER, 5
        )

        ### check box for sql dump of the MasterScan ###
        self.sizer_v_masterScanInSQL = wx.BoxSizer(wx.HORIZONTAL)
        self.checkBox_masterScanInSQL = wx.CheckBox(
            self, -1, "Dump MasterScan in SQL compatible format"
        )
        self.sizer_v_masterScanInSQL.Add(
            self.checkBox_masterScanInSQL, 0, wx.LEFT | wx.CENTER, 20
        )
        ...
        self.sizer_v_sumFattyAcids.Add(
            self.checkBox_sumFattyAcids, 0, wx.LEFT | wx.CENTER, 20
        )

        self.sizer_v_settingsPrefix = wx.BoxSizer(wx.HORIZONTAL)
        self.checkBox_settingsPrefix = wx.CheckBox(
            self, -1, "Attach the settings name on the MasterScan file name"
        )
        self.checkBox_settingsPrefix.SetToolTip(
            wx.ToolTip(
                "Attache the name of the setting with which the MasterScan was build "
                + "on the file name of the MasterScan."
            )
        )
        self.sizer_v_settingsPrefix.Add(
...
class LpdxFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # was present
        self.lpdxOptions["defaultImportSettings"] = (
            "lpdxImportSettings_benchmark.ini",
            type(""),
        )
        ...
        for option in list(self.lpdxOptions.keys()):
            if self.confParseOpts.has_option(self.settingDefaults, option):
                ...
                self.confParseOpts.set(
                    self.settingDefaults, option, self.lpdxOptions[option]
                )
        ...
        self.label_mstools_InputSection.SetFont(
            wx.Font(
                self.font_units_size,
                wx.FONTFAMILY_SWISS,
                wx.FONTSTYLE_NORMAL,
                wx.FONTWEIGHT_NORMAL,
            )
        )
        self.label_mstools_InputSection_mz = wx.StaticText(
            self.notebook_1_pane_4, -1, "m/z value"
        )
        self.label_mstools_InputSection_sumComposition = wx.StaticText(
            self.notebook_1_pane_4, -1, "sc-constraint or sum composition"
        )
        self.label_mstools_InputSection_doubleBond_1 = wx.StaticText(
            self.notebook_1_pane_4, -1, "lDB"
        )
        self.label_mstools_InputSection_doubleBond_2 = wx.StaticText(
            self.notebook_1_pane_4, -1, "hDB"
        )
        self.label_mstools_InputSection_charge = wx.StaticText(
            self.notebook_1_pane_4, -1, "chg"
        )
        self.label_mstools_InputSection_accuracy = wx.StaticText(
            self.notebook_1_pane_4, -1, "acc"
        )
        self.label_mstools_InputSection_accuracy_blank = wx.StaticText(
            self.notebook_1_pane_4, -1, "  "
        )
        self.label_mstools_InputSection_accuracy_ppm = wx.StaticText(
            self.notebook_1_pane_4, -1, "ppm"
        )
        self.text_ctrl_mstools_InputSection_mz = wx.TextCtrl(
            self.notebook_1_pane_4, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_mstools_InputSection_mz.SetToolTip(
            wx.ToolTip("Input a m/z value in Da.")
        )
        self.text_ctrl_mstools_InputSection_sumComposition = wx.TextCtrl(
            self.notebook_1_pane_4, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_mstools_InputSection_sumComposition.SetToolTip(
            wx.ToolTip(
        ...
        self.text_ctrl_mstools_InputSection_doubleBond_1 = wx.TextCtrl(
            self.notebook_1_pane_4, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_mstools_InputSection_doubleBond_1.SetToolTip(
            wx.ToolTip("The lower border of double bond equivalent.")
        )
        self.text_ctrl_mstools_InputSection_doubleBond_2 = wx.TextCtrl(
            self.notebook_1_pane_4, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_mstools_InputSection_doubleBond_2.SetToolTip(
            wx.ToolTip("The higher border of double bond equivalent.")
        )
        self.text_ctrl_mstools_InputSection_charge = wx.TextCtrl(
            self.notebook_1_pane_4, -1, "", style=wx.TE_PROCESS_ENTER
        )
        ...
        self.text_ctrl_mstools_InputSection_accuracy.SetToolTip(
            wx.ToolTip("The accuracy of the m/z-to-sum-composition function")
        )
        self.button_massToSumComposition = buttons.GenButton(
            self.notebook_1_pane_4, -1, "Mass-to-sum-composition"
        )
        self.button_massToSumComposition.SetToolTip(
            wx.ToolTip(
                "Calculate possible sum compositions for the given m/z with the given accuracy. Do not forget to give the charge"
            )
        )
        self.button_sumCompositionToMass = buttons.GenButton(
            self.notebook_1_pane_4, -1, "Sum-composition-to-m/z"
        )
        self.button_sumCompositionToMass.SetToolTip(
            wx.ToolTip(
        ...
        self.label_mstools_Isotopes_precursor = wx.StaticText(
        ...
        self.text_ctrl_mstools_Isotopes_precursor.SetToolTip(
            wx.ToolTip("input sum composition of precursor ion")
        )
        self.text_ctrl_mstools_Isotopes_fragment = wx.TextCtrl(
            self.notebook_1_pane_4, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_mstools_Isotopes_fragment.SetToolTip(
            wx.ToolTip("input sum composition of fragment ion")
        )
        self.button_Isotopes = buttons.GenButton(
            self.notebook_1_pane_4, -1, "Get Isotopic distribution"
        )
        self.button_massToSumComposition.SetToolTip(
            wx.ToolTip(
        ...
        self.checkBox_mstools_Isotopes_nl = wx.CheckBox(
            self.notebook_1_pane_4, -1, "Neutral Loss"
        )
        self.label_mstools_Isotopes_blank = wx.StaticText(
            self.notebook_1_pane_4, -1, "            "
        )
        ...
        self.label_mfqlQueriesSection.SetToolTip(
            wx.ToolTip(
        ...
        self.button_AddDir = buttons.GenButton(
            self.notebook_1_pane_3, -1, "Add MFQL directory"
        )
        self.button_AddDir.SetToolTip(
            wx.ToolTip(
                "Opens a dialog for selecting a directory of MFQL files. It will load all its content to the list."
            )
        )
        self.button_NewFile = buttons.GenButton(
            self.notebook_1_pane_3, -1, "New MFQL Entry"
        )
        self.button_NewFile.SetToolTip(
            wx.ToolTip(
                "Opens a dialog for specifying a new MFQL file. The file will be opened for editing in a new panel."
            )
        )
        self.button_OpenFile = buttons.GenButton(
        ...
        self.button_RemoveEntry.SetToolTip(
            wx.ToolTip("Removes the selected entry from the list.")
        )

        # masterScan file
        self.label_MasterScanSection = wx.StaticText(
            self.notebook_1_pane_3, -1, "Select Master Scan File"
        )
        self.text_ctrl_MasterScanSection = wx.TextCtrl(
            self.notebook_1_pane_3, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_MasterScanSection.SetToolTip(
            wx.ToolTip("Specify the MasterScan file which should be queried.")
        )

        self.button_Browse_MasterScan = buttons.GenButton(
            self.notebook_1_pane_3, -1, "Browse"
        )
        ...
        self.button_Browse_OutputSection = buttons.GenButton(
            self.notebook_1_pane_3, -1, "Browse"
        )
        self.button_Browse_OutputSection.SetToolTip(
            wx.ToolTip("Specify the output (*.csv) file.")
        )
        self.button_Open_OutputSection = buttons.GenButton(
            self.notebook_1_pane_3, -1, "View"
        )
        self.button_Open_OutputSection.SetToolTip(
            wx.ToolTip("Opens the generated output to take a look inside.")
        )

        # options
        self.label_RunOptions = wx.StaticText(
            self.notebook_1_pane_3, -1, "Optional settings for this run"
        )
        ...
        self.choice_RunOptions_MSMS_type.SetStringSelection("ppm")
        ...
        self.checkBox_OptionsSection_isocorrect_ms = wx.CheckBox(
            self.notebook_1_pane_3, -1, "Isotopic Correction MS"
        )
        ...
        self.checkBox_OptionsSection_isocorrect_msms.SetToolTip(
            wx.ToolTip(
                "Isotopic correction of quantitative information in MS/MS spectra"
            )
        )
        self.checkBox_OptionsSection_complement_sc = wx.CheckBox(
            self.notebook_1_pane_3, -1, "Generate Complement MasterScan"
        )
        self.checkBox_OptionsSection_complement_sc.SetToolTip(
            wx.ToolTip(
                "Generate the complement MasterScan and saved it as <name>-complement.sc in the origin directory."
            )
        )
        self.checkBox_OptionsSection_dumpMasterScan = wx.CheckBox(
        ...
        self.checkBox_OptionsSection_tabLimited.SetToolTip(
            wx.ToolTip("Use tabs as delimiter instead as commas.")
        )
        self.checkBox_OptionsSection_compress = wx.CheckBox(
            self.notebook_1_pane_3, -1, "Compress"
        )
        self.checkBox_OptionsSection_compress.SetToolTip(
            wx.ToolTip("No output of query names.")
        )
        self.checkBox_OptionsSection_nohead = wx.CheckBox(
        ...
        self.checkBox_generateStatistics.SetToolTip(
            wx.ToolTip(
        ...
        self.checkBox_noPermutations = wx.CheckBox(
            self.notebook_1_pane_3, -1, "No permutations"
        )
        self.checkBox_noPermutations.SetValue(True)
        self.checkBox_noPermutations.SetToolTip(
            wx.ToolTip(
...
intensity."""
        ...
        self.button_Open_DumpSection = buttons.GenButton(
            self.notebook_1_pane_3, -1, "View dump file"
        )
        self.button_Open_DumpSection.SetToolTip(
            wx.ToolTip("Opens the dump file to take a look inside.")
        )

        # run
        self.button_RunLipidX = buttons.GenButton(
            self.notebook_1_pane_3, -1, "Run LipidXplorer"
        )
        self.button_RunLipidX.SetToolTip(
            wx.ToolTip(
        ...
        self.label_ImportDataSection = fancytext.StaticFancyText(
            self.notebook_1_pane_2, -1, strFancy
        )
        ...
        self.text_ctrl_ImportDataSection = wx.TextCtrl(
            self.notebook_1_pane_2, -1, "", style=wx.TE_PROCESS_ENTER
        )
        self.text_ctrl_ImportDataSection.SetToolTip(
            wx.ToolTip(
        ...
        self.button_Browse_ImportDataSection = buttons.GenButton(
            self.notebook_1_pane_2, -1, "Browse"
        )
        self.button_Browse_ImportDataSection.SetToolTip(
            wx.ToolTip(
                "Opens a dialog for selection the import data folder. All following text fields will be filled automatically."
            )
        )
        self.button_Browse_ImportDataSection.SetBackgroundColour(
            wx.Colour(140, 250, 140)
        )
        ...
        self.combo_ctrl_ImportDataSection.SetToolTip(
            wx.ToolTip(
                """Choose the type of the mass spec data:
...
"""
        ...
        self.checkBox_pisSpectra = wx.CheckBox(
            self.notebook_1_pane_2, -1, "PIS spectra"
        )
        self.checkBox_pisSpectra.SetToolTip(
            wx.ToolTip(
        ...
        self.label_SettingsSection_occupationThr_groups = buttons.GenButton(
            self.notebook_1_pane_2, -1, "Group samples"
        )
        ...
        self.label_OutputMasterScanSection = wx.StaticText(
            self.notebook_1_pane_2, -1, "Specify output MasterScan file"
        )
        self.text_ctrl_OutputMasterScanSection = wx.TextCtrl(
            self.notebook_1_pane_2, -1, ""
        )
        self.text_ctrl_OutputMasterScanSection.SetToolTip(
            wx.ToolTip(
                "Specify the path and the name of the MasterScan database for the mass spec data selected above."
            )
        )
        self.button_Browse_OutputMasterScanSection = buttons.GenButton(
            self.notebook_1_pane_2, -1, "Browse"
        )
        ...
        # start Import
        self.button_StartImport = buttons.GenButton(
        ...
        self.text_ctrl_LoadIniSection.SetValue(
            self.lpdxOptions["defaultImportSettings"]
        )
        ...
        self.button_Browse_LoadIniSection = buttons.GenButton(
        ...
        self.label_SelectSettingSection.SetToolTip(
            wx.ToolTip(
        ...
        self.button_Delete_LoadIniSection = buttons.GenButton(
        ...
        self.button_Save_LoadIniSection.SetToolTip(
            wx.ToolTip("Saves the current settings to the selected section.")
        )
        self.button_SaveAs_LoadIniSection = buttons.GenButton(
            self.notebook_1_pane_5, -1, "Save As ..."
        )
        self.button_SaveAs_LoadIniSection.SetToolTip(
            wx.ToolTip("Saves the current settings to a new section.")
        )

        self.button_Save_LoadIniSection.SetMinSize(
            (button1_small_w * 1.3, button1_small_h * 1.3)
        )
        self.button_Delete_LoadIniSection.SetMinSize(
            (button1_small_w * 1.3, button1_small_h * 1.3)
        )
        self.button_SaveAs_LoadIniSection.SetMinSize(
            (button1_small_w * 1.3, button1_small_h * 1.3)
        )
        ...
        self.choice_SettingsSection_polarity = wx.Choice(
            self.notebook_1_pane_5, -1, choices=self.polarities  # "Polarity",
        )
        ...
        self.choice_SettingsSection_threshold_ms.SetToolTip(
        ...
        self.label_SettingsSection_precursorMassShift = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS1 offset"
        )
        self.label_SettingsSection_precursorMassShift.SetToolTip(
            wx.ToolTip(
                "MS1 m/z offset correction. All MS1 m/z values will be shifted by this value in Da."
            )
        )

        self.label_SettingsSection_precursorMassShift_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "Da"
        )

        self.label_SettingsSection_precursorMassShiftOrbi = wx.StaticText(
            self.notebook_1_pane_5, -1, "PMO"
        )
        self.label_SettingsSection_precursorMassShiftOrbi.SetToolTip(
            wx.ToolTip(
        ...
        self.label_SettingsSection_precursorMassShiftOrbi_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "Da"
        )

        self.label_SettingsSection_selectionWindow = wx.StaticText(
        ...
        self.label_SettingsSection_timerange = wx.StaticText(
        ...
        self.label_SettingsSection_massrange = wx.StaticText(
        ...
        self.label_SettingsSection_massrange_ms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "m/z,m/z"
        )
        self.label_SettingsSection_massrange_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_massrange_msms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "m/z,m/z"
        )
        self.label_SettingsSection_resolution = wx.StaticText(
            self.notebook_1_pane_5, -1, "resolution"
        )
        self.label_SettingsSection_resolution_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
...
\nNOTE that this resolution referes to the smalles mass in the spectra. The change of resolution for greater masses is handled with the 'resolution gradien' below."""
        ...
        self.label_SettingsSection_resolution_ms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "FMHW"
        )
        self.label_SettingsSection_resolution_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_resolution_msms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "FMHW"
        )
        self.label_SettingsSection_tolerance = wx.StaticText(
            self.notebook_1_pane_5, -1, "tolerance"
        )
        self.label_SettingsSection_tolerance.SetToolTip(
            wx.ToolTip(
                "Set the accuracy of the acquired masses according to mass spec settings"
            )
        )
        self.label_SettingsSection_tolerance_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
        self.label_SettingsSection_tolerance_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_threshold = wx.StaticText(
            self.notebook_1_pane_5, -1, "threshold"
        )
        self.label_SettingsSection_threshold.SetToolTip(
            wx.ToolTip(
                "Set a threshold to import only masses above a certain intensity"
            )
        )
        self.label_SettingsSection_threshold_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
        self.label_SettingsSection_threshold_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_occupationThr = wx.StaticText(
            self.notebook_1_pane_5, -1, "min occupation"
        )
        self.label_SettingsSection_occupationThr.SetToolTip(
            wx.ToolTip(
                "Select a minimum percentage with which a peak should be appear in all samples, the value should be between 0 and 1"
            )
        )
        self.label_SettingsSection_occupationThr_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
        self.label_SettingsSection_occupationThr_ms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "[0..1]"
        )
        self.label_SettingsSection_occupationThr_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_occupationThr_msms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "[0..1]"
        )
        self.label_SettingsSection_resDelta = wx.StaticText(
            self.notebook_1_pane_5, -1, "resolution gradient"
        )
        self.label_SettingsSection_resDelta.SetToolTip(
            wx.ToolTip(
                "Give a gradient of how the resolution changes the greater the m/z value is"
            )
        )
        self.label_SettingsSection_resDelta_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
        self.label_SettingsSection_resDelta_ms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "res/(m/z)"
        )
        self.label_SettingsSection_resDelta_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_resDelta_msms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "res/(m/z)"
        )
        self.label_SettingsSection_calibration = wx.StaticText(
            self.notebook_1_pane_5, -1, "calibration masses"
        )
        self.label_SettingsSection_calibration.SetToolTip(
            wx.ToolTip(
                "Given m/z values are used for linear recalibration of the spectra"
            )
        )
        # self.label_SettingsSection_calibration_unit = wx.StaticText(pane, -1, "m/z, m/z, ...")
        self.label_SettingsSection_calibration_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
        self.label_SettingsSection_calibration_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_filter_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS"
        )
        self.label_SettingsSection_filter_ms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "[0..1]"
        )
        self.label_SettingsSection_filter_ms.SetToolTip(
            wx.ToolTip(
                "A minimum frequency for a peak appearing in all associated scans, the value should be between 0 and 1"
            )
        )
        self.label_SettingsSection_filter_msms = wx.StaticText(
            self.notebook_1_pane_5, -1, "frequency filter"
        )
        self.label_SettingsSection_filter_ms_ms = wx.StaticText(
            self.notebook_1_pane_5, -1, "MS/MS"
        )
        self.label_SettingsSection_filter_msms_unit = wx.StaticText(
            self.notebook_1_pane_5, -1, "[0..1]"
        )

        self.label_SettingsSection_filter_msms.SetToolTip(
            wx.ToolTip(
                "A minimum frequency for a peak appearing in all associated scans, the value is between 0 and 1 "
            )
        )
        self.text_ctrl_SettingsSection_precursorMassShift = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_precursorMassShiftOrbi = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_selectionWindow = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_timerange1 = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_timerange2 = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_massrange_ms1 = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_massrange_ms2 = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_massrange_msms1 = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_massrange_msms2 = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_resolution_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_resolution_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_tolerance_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_tolerance_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_threshold_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_threshold_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_occupationThr_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_occupationThr_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_resDelta_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_resDelta_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_calibration_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_calibration_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, ""
        )
        self.text_ctrl_SettingsSection_filter_ms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, "0"
        )
        self.text_ctrl_SettingsSection_filter_msms = wx.TextCtrl(
            self.notebook_1_pane_5, -1, "0"
        )
        ...
        self.alignmentSetting = SetAlignmentFrame(
            self, -1, "Choose the preferred alignment method"
        )
        self.outputOptionSetting = SetOutputOptionFrame(
            self, -1, "Set your output options"
        )
    ...
    def __bind_events(self):
        ...
        self.Bind(
            wx.EVT_BUTTON,
            self.OnBrowse_ImportData,
            self.button_Browse_ImportDataSection,
        )
        self.Bind(
            wx.EVT_BUTTON,
            self.OnBrowse_OutputMasterScan,
        ...
        self.Bind(
            wx.EVT_CHOICE,
            self.OnChoice_Tolerance_MS,
            self.choice_SettingsSection_tolerance_ms,
        )
        self.Bind(
            wx.EVT_CHOICE,
            self.OnChoice_Tolerance_MSMS,
            self.choice_SettingsSection_tolerance_msms,
        )
        self.Bind(
            wx.EVT_CHOICE,
            self.OnChoice_Threshold_MS,
            self.choice_SettingsSection_threshold_ms,
        )
        self.Bind(
            wx.EVT_CHOICE,
            self.OnChoice_Threshold_MSMS,
            self.choice_SettingsSection_threshold_msms,
        )
        ...
        dropTargetSettingsFile = FileDrawerDropTarget(
            self.text_ctrl_LoadIniSection, self.OnBrowse_LoadIni_Body, "ini"
        )
    ...
    def readOptions(self):
        ...
        project.options["timerange"] = "(%s,%s)" % (
            self.text_ctrl_SettingsSection_timerange1.GetValue(),
            self.text_ctrl_SettingsSection_timerange2.GetValue(),
        )
        project.options[
            "MScalibration"
        ] = self.text_ctrl_SettingsSection_calibration_ms.GetValue()
        project.options[
            "MSMScalibration"
        ...
        project.options["MSmassrange"] = "(%s,%s)" % (
            self.text_ctrl_SettingsSection_massrange_ms1.GetValue(),
            self.text_ctrl_SettingsSection_massrange_ms2.GetValue(),
        )
        project.options["MSMSmassrange"] = "(%s,%s)" % (
            self.text_ctrl_SettingsSection_massrange_msms1.GetValue(),
            self.text_ctrl_SettingsSection_massrange_msms2.GetValue(),
        )
        project.options[
            "MStolerance"
        ] = self.text_ctrl_SettingsSection_tolerance_ms.GetValue()
        project.options[
            "MSMStolerance"
        ] = self.text_ctrl_SettingsSection_tolerance_msms.GetValue()
        project.options[
            "MStoleranceType"
        ] = self.choice_SettingsSection_tolerance_ms.GetString(
            self.choice_SettingsSection_tolerance_ms.GetSelection()
        )
        project.options[
            "MSMStoleranceType"
        ] = self.choice_SettingsSection_tolerance_msms.GetString(
            self.choice_SettingsSection_tolerance_msms.GetSelection()
        )
        project.options[
            "MSresolution"
        ] = self.text_ctrl_SettingsSection_resolution_ms.GetValue()
        project.options[
            "MSMSresolution"
        ] = self.text_ctrl_SettingsSection_resolution_msms.GetValue()
        project.options[
            "MSresolutionDelta"
        ] = self.text_ctrl_SettingsSection_resDelta_ms.GetValue()
        project.options[
            "MSMSresolutionDelta"
        ] = self.text_ctrl_SettingsSection_resDelta_msms.GetValue()
        project.options[
            "MSthreshold"
        ] = self.text_ctrl_SettingsSection_threshold_ms.GetValue()
        project.options[
            "MSMSthreshold"
        ] = self.text_ctrl_SettingsSection_threshold_msms.GetValue()
        project.options[
            "MSthresholdType"
        ] = self.choice_SettingsSection_threshold_ms.GetString(
            self.choice_SettingsSection_threshold_ms.GetSelection()
        )
        project.options[
            "MSMSthresholdType"
        ] = self.choice_SettingsSection_threshold_msms.GetString(
            self.choice_SettingsSection_threshold_msms.GetSelection()
        )
        project.options[
            "MSminOccupation"
        ] = self.text_ctrl_SettingsSection_occupationThr_ms.GetValue()
        project.options[
            "MSMSminOccupation"
        ] = self.text_ctrl_SettingsSection_occupationThr_msms.GetValue()
        project.options[
            "precursorMassShift"
        ] = self.text_ctrl_SettingsSection_precursorMassShift.GetValue()
        project.options[
            "precursorMassShiftOrbi"
        ] = self.text_ctrl_SettingsSection_precursorMassShiftOrbi.GetValue()
        project.options[
            "alignmentMethodMS"
        ] = self.alignmentSetting.alignmentMethodsMS_intern[
            self.alignmentSetting.radioBox_ms_alignment.GetSelection()
        ]
        project.options[
            "alignmentMethodMSMS"
        ] = self.alignmentSetting.alignmentMethodsMSMS_intern[
            self.alignmentSetting.radioBox_msms_alignment.GetSelection()
        ]
        project.options[
            "scanAveragingMethod"
        ] = self.alignmentSetting.scanAveragingMethods_intern[
            self.alignmentSetting.radioBox_scanAveraging.GetSelection()
        ]
        project.options[
            "isotopicCorrection_MSMS"
        ] = (
            self.debugSetting.checkBox_IsotopicCorrection_MSMS.GetValue()
        )  # here starts the Set debugging Options from the Debug menu
        project.options[
            "removeIsotopes"
        ] = self.debugSetting.checkBox_removeIsotopes.GetValue()
        project.options[
            "isotopesInMasterScan"
        ] = self.debugSetting.checkBox_isotopesInMasterscan.GetValue()
        project.options[
            "monoisotopicCorrection"
        ] = self.debugSetting.checkBox_monoisotopicCorrection.GetValue()
        project.options[
            "relativeIntensity"
        ] = self.debugSetting.checkBox_relativeIntensity.GetValue()
        project.options[
            "logMemory"
        ] = (
            self.debugSetting.checkBox_MemoryLog.GetValue()
        )  # here starts the Set debugging Options from the Debug menu
        project.options[
            "intensityCorrection"
        ] = (
            self.outputOptionSetting.checkBox_correctIntensities.GetValue()
        )  # here starts the output options menu
        project.options[
            "intensityCorrectionPrecursor"
        ] = self.outputOptionSetting.text_ctrl_precursor.GetValue()
        project.options[
            "intensityCorrectionFragment"
        ] = self.outputOptionSetting.text_ctrl_fragment.GetValue()
        project.options[
            "masterScanInSQL"
        ] = self.outputOptionSetting.checkBox_masterScanInSQL.GetValue()
        project.options[
            "sumFattyAcids"
        ] = self.outputOptionSetting.checkBox_sumFattyAcids.GetValue()
        project.options[
            "settingsPrefix"
        ...
        project.options[
            ...
            self.choice_RunOptions_MS_type.GetSelection()
        )
        project.options[
            "optionalMSMStoleranceType"
        ] = self.choice_RunOptions_MSMS_type.GetString(
            self.choice_RunOptions_MSMS_type.GetSelection()
        )
        project.options[
            "isotopicCorrectionMS"
        ] = self.checkBox_OptionsSection_isocorrect_ms.GetValue()
        project.options[
            "isotopicCorrectionMSMS"
        ] = self.checkBox_OptionsSection_isocorrect_msms.GetValue()
        project.options[
    ...
    def OnMenuProjectLoad(self, evt, pFile=""):
        ...
        if not options["ini"] is None and options["ini"] != "":
            ...
            self.choice_SelectSettingSection.SetSelection(
                int(options["setting"])
            )  # select by number, this should be changed to string TODO
        ...
        try:
            ...
            self.text_ctrl_SettingsSection_massrange_ms2.SetValue(
                options["MSmassrange"][1]
            )
            self.text_ctrl_SettingsSection_massrange_msms1.SetValue(
                options["MSMSmassrange"][0]
            )
            self.text_ctrl_SettingsSection_massrange_msms2.SetValue(
                options["MSMSmassrange"][1]
            )
            self.text_ctrl_SettingsSection_tolerance_ms.SetValue(
                (options["MStolerance"])
            )
            self.text_ctrl_SettingsSection_tolerance_msms.SetValue(
                (options["MSMStolerance"])
            )
            self.choice_SettingsSection_tolerance_ms.SetStringSelection(
                (options["MStoleranceType"])
            )
            self.choice_SettingsSection_tolerance_msms.SetStringSelection(
                (options["MSMStoleranceType"])
            )
            self.text_ctrl_SettingsSection_resolution_ms.SetValue(
                (options["MSresolution"])
            )
            self.text_ctrl_SettingsSection_resolution_msms.SetValue(
                (options["MSMSresolution"])
            )
            self.text_ctrl_SettingsSection_resDelta_ms.SetValue(
                (options["MSresolutionDelta"])
            )
            self.text_ctrl_SettingsSection_resDelta_msms.SetValue(
                (options["MSMSresolutionDelta"])
            )
            self.text_ctrl_SettingsSection_threshold_ms.SetValue(
                (options["MSthreshold"])
            )
            self.text_ctrl_SettingsSection_threshold_msms.SetValue(
                (options["MSMSthreshold"])
            )
            self.choice_SettingsSection_threshold_ms.SetStringSelection(
                options["MSthresholdType"]
            )
            self.choice_SettingsSection_threshold_msms.SetStringSelection(
                options["MSMSthresholdType"]
            )
            self.text_ctrl_SettingsSection_occupationThr_ms.SetValue(
                (options["MSminOccupation"])
            )
            self.text_ctrl_SettingsSection_occupationThr_msms.SetValue(
                (options["MSMSminOccupation"])
            )
            self.text_ctrl_SettingsSection_precursorMassShift.SetValue(
                (options["precursorMassShift"])
            )
            self.text_ctrl_SettingsSection_precursorMassShiftOrbi.SetValue(
                (options["precursorMassShiftOrbi"])
            )
            self.alignmentSetting.radioBox_ms_alignment.SetSelection(
                self.alignmentSetting.alignmentMethodsMS_intern.index(
                    options["alignmentMethodMS"]
                )
            )
            self.alignmentSetting.radioBox_msms_alignment.SetSelection(
                self.alignmentSetting.alignmentMethodsMSMS_intern.index(
                    options["alignmentMethodMSMS"]
                )
            )
            self.alignmentSetting.radioBox_scanAveraging.SetSelection(
                self.alignmentSetting.scanAveragingMethods_intern.index(
                    options["scanAveragingMethod"]
                )
            )
            # here starts the Set debugging Options from the Debug menu
            self.debugSetting.checkBox_IsotopicCorrection_MSMS.SetValue(
                strToBool(options["isotopicCorrection_MSMS"])
            )
            self.debugSetting.OnCheckIsotopicCorrection_MSMS(None)
            self.debugSetting.checkBox_removeIsotopes.SetValue(
                strToBool(options["removeIsotopes"])
            )
            self.debugSetting.OnCheckRemoveIsotopes(None)
            self.debugSetting.checkBox_isotopesInMasterscan.SetValue(
                strToBool(options["isotopesInMasterScan"])
            )
            self.debugSetting.OnCheckIsotopesInMasterScan(None)
            self.debugSetting.checkBox_monoisotopicCorrection.SetValue(
                strToBool(options["monoisotopicCorrection"])
            )
            self.debugSetting.OnCheckMonoisotopicCorrection(None)
            self.debugSetting.checkBox_relativeIntensity.SetValue(
                strToBool(options["relativeIntensity"])
            )
            self.debugSetting.OnCheckRelativeIntensity(None)
            self.debugSetting.checkBox_MemoryLog.SetValue(
                strToBool(options["logMemory"])
            )

            # here starts the output options menu(options['correctIntensities']
            self.outputOptionSetting.checkBox_correctIntensities.SetValue(
                strToBool(options["intensityCorrection"])
            )
            self.outputOptionSetting.text_ctrl_precursor.SetValue(
                options["intensityCorrectionPrecursor"]
            )
            self.outputOptionSetting.text_ctrl_fragment.SetValue(
                options["intensityCorrectionFragment"]
            )
            self.outputOptionSetting.checkBox_masterScanInSQL.SetValue(
                strToBool(options["masterScanInSQL"])
            )
            self.outputOptionSetting.checkBox_sumFattyAcids.SetValue(
                strToBool(options["sumFattyAcids"])
            )
            ...
            self.choice_RunOptions_MSMS_type.GetString(
                self.choice_RunOptions_MSMS_type.SetStringSelection(
                    options["optionalMSMStoleranceType"]
                )
            )
            self.checkBox_OptionsSection_isocorrect_ms.SetValue(
                strToBool(options["isotopicCorrectionMS"])
            )
            self.checkBox_OptionsSection_isocorrect_msms.SetValue(
                strToBool(options["isotopicCorrectionMSMS"])
            )
            ...
            self.checkBox_OptionsSection_tabLimited.SetValue(
                strToBool(options["tabLimited"])
            )
        ...
        if (
            len(self.listConfigurations) > 0
            and self.choice_SelectSettingSection.GetSelection()
        ):
            self.currentConfiguration = self.listConfigurations[
                self.choice_SelectSettingSection.GetSelection()
            ]
    ...
    def OnText(self, evt):
        if not self.isChangedAndNotSavedCurrentConfiguration:
            if (
                ...
                or evt.GetId()
                == self.text_ctrl_SettingsSection_precursorMassShiftOrbi.GetId()
            ):
            ...
            if evt.GetId() == self.dict_text_ctrl[key].GetId():
                ...
                for i in range(self.notebook_1.GetPageCount()):
                    if (
                        ...
                        == self.dict_text_ctrl[key].GetParent()
                    ):
    ...
    def startConvertWiff(self):
        ...
        if os.path.exists(wiffIn):
            if os.path.exists(wiffOut):
                ...
                thinking = wx.ProgressDialog(
                    "Thinking ...",
                    "Thinking ...",
                    max,
                    self,
                    wx.PD_AUTO_HIDE | wx.ICON_EXCLAMATION | wx.PD_SMOOTH,
                )
                        ...
                        if re.match(".*\.wiff", f, re.IGNORECASE):
                            ...
                            if self.flagMC:  # msconvert
                                if self.flagCentroid:
                                    strStartWiff = (
                                        'msconvert-with-centroization.bat "%s" "%s"'
                                        % (os.path.join(root, f), wiffOut)
                                    )
                                else:
                                    strStartWiff = (
                                        'msconvert-without-centroization.bat "%s" "%s"'
                                        % (os.path.join(root, f), wiffOut)
                                    )
                            else:  # readw
                                if self.flagCentroid:
                ...
                if exitCode == 0:
                    ...
                    dlg = wx.MessageDialog(
                        self,
                        "Problems with Wiff file conversion!",
                        "Failed",
                        wx.OK | wx.ICON_INFORMATION,
                    )
                    if dlg.ShowModal() == wx.ID_OK:
                ...
                dlg = wx.MessageDialog(
                    self,
                    "The path '%s' does not exist!" % wiffOut,
                    "Error",
                    wx.OK | wx.ICON_HAND,
                )
                if dlg.ShowModal() == wx.ID_OK:
            ...
            dlg = wx.MessageDialog(
                self,
                "The path '%s' does not exist!" % wiffIn,
                "Error",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
        ...
        if os.path.exists(rawIn):
            if os.path.exists(rawOut):
                ...
                if exitCode == 0:
                    ...
                    dlg = wx.MessageDialog(
                        self,
                        "Problems with Raw file conversion!",
                        "Failed",
                        wx.OK | wx.ICON_INFORMATION,
                    )
                    if dlg.ShowModal() == wx.ID_OK:
                ...
                dlg = wx.MessageDialog(
                    self,
                    "The path '%s' does not exist!" % rawOut,
                    "Error",
                    wx.OK | wx.ICON_HAND,
                )
                if dlg.ShowModal() == wx.ID_OK:
            ...
            dlg = wx.MessageDialog(
                self,
                "The path '%s' does not exist!" % rawIn,
                "Error",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def OnBrowse_ImportData_Body(self, filePath):
        if not os.path.exists(filePath):
            dlg = wx.MessageDialog(
                self,
                "The path '%s' does not exist!" % filePath,
                "Error",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def OnSave_LoadIni(self, evt):
        if self.currentConfiguration != "":
            ...
            self.confParse.set(
                section,
                "MSthresholdType",
                "%s" % self.store_SettingsSection_threshold_ms,
            )
            self.confParse.set(
                section,
                "MSMSthresholdType",
                "%s" % self.store_SettingsSection_threshold_msms,
            )
            self.confParse.set(
                section,
                "MSminOccupation",
    ...
    def OnSaveAs_LoadIni(self, evt):
        ...
        if not self.confParse:
            ...
            msgDlg = wx.MessageDialog(
                self,
                "You have to load an existing *.ini file first. Do you want to create one?",
                "Caption",
    ...
    def OnOpen_Output(self, evt):
        ...
        if not os.path.exists(fileName):
            dlg = wx.MessageDialog(
                self,
                "The path '%s' does not exist!" % fileName,
                "Error",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def OnBrowse_MasterScan_Body(self, filePath):
        if not re.match(".*\.sc$", filePath):
            dlg = wx.MessageDialog(
                self,
                "The filename '%s' has no '.sc' at its end!" % filePath,
                "Error",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def OnOpen_Dump(self, evt):
        ...
        if not os.path.exists(fileName):
            dlg = wx.MessageDialog(
                self,
                "The dump of your MasterScan does not exist. It will be generated if you check 'dump MasterScan' and hit the 'Run LipidXplorer' button.",
                "Attention!",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def OnConfigurationChoice(self, evt):
        if self.isChangedAndNotSavedCurrentConfiguration:
            dlg = wx.MessageDialog(
                self,
                "Modified configuration '%s' is not saved. Save it?"
                % self.currentConfiguration,
                "Ups..",
                wx.YES | wx.NO | wx.ICON_HAND,
            )
    ...
    def fillConfiguration(self, setting):
        ...
        if self.confParse.has_option(setting, "MSminOccupation"):
            self.text_ctrl_SettingsSection_occupationThr_ms.ChangeValue(
                self.confParse.get(setting, "MSminOccupation")
            )
        else:
            self.text_ctrl_SettingsSection_occupationThr_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMSminOccupation"):
            self.text_ctrl_SettingsSection_occupationThr_msms.ChangeValue(
                self.confParse.get(setting, "MSMSminOccupation")
            )
        else:
            self.text_ctrl_SettingsSection_occupationThr_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSthreshold"):
            self.text_ctrl_SettingsSection_threshold_ms.ChangeValue(
                self.confParse.get(setting, "MSthreshold")
            )
        else:
            self.text_ctrl_SettingsSection_threshold_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMSthreshold"):
            self.text_ctrl_SettingsSection_threshold_msms.ChangeValue(
                self.confParse.get(setting, "MSMSthreshold")
            )
        else:
            self.text_ctrl_SettingsSection_threshold_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSthresholdType"):
            self.choice_SettingsSection_threshold_ms.SetStringSelection(
                self.confParse.get(setting, "MSthresholdType")
            )
            self.store_SettingsSection_threshold_ms = self.confParse.get(
        ...
        if self.confParse.has_option(setting, "MSMSthresholdType"):
            self.choice_SettingsSection_threshold_msms.SetStringSelection(
                self.confParse.get(setting, "MSMSthresholdType")
            )
            self.store_SettingsSection_threshold_msms = self.confParse.get(
        ...
        if self.confParse.has_option(setting, "MSresolution"):
            self.text_ctrl_SettingsSection_resolution_ms.ChangeValue(
                self.confParse.get(setting, "MSresolution")
            )
        else:
            self.text_ctrl_SettingsSection_resolution_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMSresolution"):
            self.text_ctrl_SettingsSection_resolution_msms.ChangeValue(
                self.confParse.get(setting, "MSMSresolution")
            )
        else:
            self.text_ctrl_SettingsSection_resolution_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSresolutionDelta"):
            self.text_ctrl_SettingsSection_resDelta_ms.ChangeValue(
                self.confParse.get(setting, "MSresolutionDelta")
            )
        else:
            self.text_ctrl_SettingsSection_resDelta_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMSresolutionDelta"):
            self.text_ctrl_SettingsSection_resDelta_msms.ChangeValue(
                self.confParse.get(setting, "MSMSresolutionDelta")
            )
        else:
            self.text_ctrl_SettingsSection_resDelta_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MScalibration"):
            self.text_ctrl_SettingsSection_calibration_ms.ChangeValue(
                self.confParse.get(setting, "MScalibration")
            )
        else:
            self.text_ctrl_SettingsSection_calibration_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMScalibration"):
            self.text_ctrl_SettingsSection_calibration_msms.ChangeValue(
                self.confParse.get(setting, "MSMScalibration")
            )
        else:
            self.text_ctrl_SettingsSection_calibration_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSfilter"):
            self.text_ctrl_SettingsSection_filter_ms.ChangeValue(
                self.confParse.get(setting, "MSfilter")
            )
        else:
            self.text_ctrl_SettingsSection_filter_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMSfilter"):
            self.text_ctrl_SettingsSection_filter_msms.ChangeValue(
                self.confParse.get(setting, "MSMSfilter")
            )
        else:
            self.text_ctrl_SettingsSection_filter_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MStolerance"):
            ...
            if re.match("(\d+|\d+\.\d+)$", str):
                ...
                dlgError = wx.MessageDialog(
                    self,
                    "Cannot read MS Tolerance Value. Setting it to zero.",
                    "Error",
                    wx.OK,
                )
                self.text_ctrl_SettingsSection_tolerance_ms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "MSMStolerance"):
            ...
            if re.match("(\d+|\d+\.\d+)$", str):
                ...
                dlgError = wx.MessageDialog(
                    self,
                    "Cannot read MS/MS Tolerance Value. Setting it to zero.",
                    "Error",
                    wx.OK,
                )
                self.text_ctrl_SettingsSection_tolerance_msms.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "selectionWindow"):
            self.text_ctrl_SettingsSection_selectionWindow.ChangeValue(
                self.confParse.get(setting, "selectionWindow")
            )
        else:
            self.text_ctrl_SettingsSection_selectionWindow.ChangeValue("")
        ...
        if self.confParse.has_option(setting, "precursorMassShift"):
            self.text_ctrl_SettingsSection_precursorMassShift.ChangeValue(
                self.confParse.get(setting, "precursorMassShift")
            )
        else:
            self.text_ctrl_SettingsSection_precursorMassShift.ChangeValue("")
    ...
    def OnAddMFQL(self, evt):
        ...
        dlg = wx.FileDialog(
            self,
            "Choose a MFQL file",
            style=wx.DD_DEFAULT_STYLE | wx.FD_OPEN | wx.FD_MULTIPLE,
        )
        ...
        for key in list(self.dict_button_save.keys()):
            if evt.GetId() == self.dict_button_save[key].GetId():
                ...
                for i in range(self.notebook_1.GetPageCount()):
                    if (
                        self.notebook_1.GetPage(i)
                        == self.dict_button_save[key].GetParent()
                    ):
                        with open(self.dictMFQLScripts[key], "w") as mfqlFile:
                            self.dict_mfqlFile[key] = mfqlFile
                            mfqlFile.write(self.dict_text_ctrl[key].GetText())
    ...
    def OnSaveAsPanel(self, evt):
        ...
        dlg = wx.FileDialog(
            self,
            "Specify a filename for the MFQL file",
            style=wx.DD_DEFAULT_STYLE | wx.FD_SAVE | wx.FD_OVERWRITE_PROMPT,
        )
        dlg.SetWildcard("*.mfql files|*.mfql")
        dlg.SetPath(os.getcwd())
    ...
    def OnOpenFile(self, evt=None, newFile=None):
        ...
        if not newFile:
            for index in self.list_box_1.GetSelections():
                ...
                # 	style = wx.SIMPLE_BORDER|wx.HSCROLL|wx.ALWAYS_SHOW_SB|wx.TE_MULTILINE|wx.TE_RICH)#, size = wx.Point(835, 700))
                self.dict_text_ctrl[curScript] = PythonSTC(
                    self.dict_notebook_editor[curScript],
                    -1,
                    style=wx.SIMPLE_BORDER
                    | wx.HSCROLL
                    | wx.ALWAYS_SHOW_SB
                ...
                self.dict_text_ctrl[curScript].SetMinSize(
                    (self.GetSize()[0] - 40, self.GetSize()[1] - 150)
                )
                ...
                self.dict_button_close[curScript] = wx.Button(
                    self.dict_notebook_editor[curScript], -1, "Close"
                )
                ...
                # add the save button
                self.dict_button_save[curScript] = wx.Button(
                ...
                self.dict_button_saveAs[curScript] = wx.Button(
                    self.dict_notebook_editor[curScript], -1, "SaveAs"
                )
                ...
                # add the new button
                self.dict_button_new[curScript] = wx.Button(
                ...
                self.dict_box_sizer_horizontal[curScript].Fit(
                    self.dict_notebook_editor[curScript]
                )
                ...
                # 	wx.ALIGN_CENTER, 0)
                self.dict_box_sizer_vertical[curScript].Add(
                    self.dict_text_ctrl[curScript],
                    1,
                ...
                self.dict_box_sizer_vertical[curScript].Add(
                    self.dict_box_sizer_horizontal[curScript],
                    0,
                    wx.ALIGN_CENTER | wx.ADJUST_MINSIZE,
                    0,
                )

                self.dict_notebook_editor[curScript].SetSizerAndFit(
                    self.dict_box_sizer_vertical[curScript]
                )
            ...
            for index in self.list_box_1.GetSelections():
                ...
                self.notebook_1.AddPage(
                    self.dict_notebook_editor[curScript], curScript, True
                )
    ...
    def OnNewFile(self, evt):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            self.list_box_1.Set(list(self.dictMFQLScripts.keys()))
            self.list_box_1.SetSelection(
                list(self.dictMFQLScripts.keys()).index(p), select=True
            )
    ...
    def OnRunLipidX(self, evt):
        ...
        self.debug.progressDialog = wx.ProgressDialog(
            "Processing spectra",
    ...
    def OnMassToSumComposition(self, evt):
        ...
        if self.text_ctrl_mstools_InputSection_sumComposition.IsEmpty():
            dlg = wx.MessageDialog(
                self,
                "You have to give a sf-constraint!",
                "Attention",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
            ...
            sf_constraint = (
                self.text_ctrl_mstools_InputSection_sumComposition.GetValue()
            )

        if self.text_ctrl_mstools_InputSection_doubleBond_1.IsEmpty():
            dlg = wx.MessageDialog(
                self,
                "You have to give a lower double bond border!",
                "Attention",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
        ...
        if self.text_ctrl_mstools_InputSection_doubleBond_2.IsEmpty():
            dlg = wx.MessageDialog(
                self,
                "You have to give a higher double bond border!",
                "Attention",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
        ...
        if rslt == []:
            outtext = "No sum composition found for %s with m/z %.4f" % (
                elscp,
                float(mass),
            )
    ...
    def OnSumCompositionToMass(self, evt):
        ...
        if (
            self.text_ctrl_mstools_InputSection_sumComposition.IsEmpty()
            or self.text_ctrl_mstools_InputSection_doubleBond_1.IsEmpty()
            or self.text_ctrl_mstools_InputSection_doubleBond_2.IsEmpty()
        ):
            dlg = wx.MessageDialog(
                self,
                "You have to give a sum composition and double bond values",
                "Attention",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def OnCalcIsotopes(self, evt):
        if self.text_ctrl_mstools_Isotopes_precursor.IsEmpty():
            dlg = wx.MessageDialog(
                self,
                "You have to give a sum composition!",
                "Attention",
                wx.OK | wx.ICON_HAND,
            )
            if dlg.ShowModal() == wx.ID_OK:
        ...
        if self.text_ctrl_mstools_Isotopes_fragment.IsEmpty():
            ...
            sumCompFrg = parseElemSeq(
                self.text_ctrl_mstools_Isotopes_fragment.GetValue()
            )
        ...
        if sumCompFrg:
            ...
            if self.checkBox_mstools_Isotopes_nl.GetValue():
                ...
                (Mtx, monoistopic) = isotopicValuesInter(
                    sumCompNL["C"],
                    sumCompNL["H"],
                    sumCompNL["O"],
                    sumCompNL["N"],
            ...
            for index in range(len(mz)):
                ...
                str += "%.4f   %.4f\n" % (
                    sumComp.getWeight() + 1.00055 * index,
                    intens[index] * monoisotopic,
                )
            self.text_ctrl_mstools_Isotopes_output.SetValue(str)
    ...
    def collectSettings(self, setting):
        ...
        try:
            if self.confParse.has_option(setting, "MSminOccupation"):
                self.optsImport["MSminOccupation"] = self.confParse.get(
                    setting, "MSminOccupation"
                )
            else:
                self.optsImport["MSminOccupation"] = ""

            if self.confParse.has_option(setting, "MSMSminOccupation"):
                self.optsImport["MSMSminOccupation"] = self.confParse.get(
                    setting, "MSMSminOccupation"
                )
            else:
                self.optsImport["MSMSminOccupation"] = ""

            if self.confParse.has_option(setting, "MSthreshold"):
                self.optsImport["MSthreshold"] = self.confParse.get(
                    setting, "MSthreshold"
                )
            else:
            ...
            if self.confParse.has_option(setting, "MSthresholdType"):
                self.optsImport["MSthresholdType"] = self.confParse.get(
                    setting, "MSthresholdType"
                )
            else:
            ...
            if self.confParse.has_option(setting, "MSMSthresholdType"):
                self.optsImport["MSMSthresholdType"] = self.confParse.get(
                    setting, "MSMSthresholdType"
                )
            else:
            ...
            if self.confParse.has_option(setting, "MSresolution"):
                self.optsImport["MSresolution"] = self.confParse.get(
                    setting, "MSresolution"
                )
            else:
                self.optsImport["MSresolution"] = ""

            if self.confParse.has_option(setting, "MSMSresolution"):
                self.optsImport["MSMSresolution"] = self.confParse.get(
                    setting, "MSMSresolution"
                )
            else:
                self.optsImport["MSMSresolution"] = ""

            if self.confParse.has_option(setting, "MSresolutionDelta"):
                self.optsImport["MSresolutionDelta"] = self.confParse.get(
                    setting, "MSresolutionDelta"
                )
            else:
                self.optsImport["MSresolutionDelta"] = ""

            if self.confParse.has_option(setting, "MSMSresolutionDelta"):
                self.optsImport["MSMSresolutionDelta"] = self.confParse.get(
                    setting, "MSMSresolutionDelta"
                )
            else:
                self.optsImport["MSMSresolutionDelta"] = ""

            if self.confParse.has_option(setting, "MScalibration"):
                self.optsImport["MScalibration"] = self.confParse.get(
                    setting, "MScalibration"
                )
            else:
            ...
            if self.confParse.has_option(setting, "MSMScalibration"):
                self.optsImport["MSMScalibration"] = self.confParse.get(
                    setting, "MSMScalibration"
                )
            else:
                self.optsImport["MSMScalibration"] = ""

            if self.confParse.has_option(setting, "MSMSfilter"):
                self.optsImport["MSMSfilter"] = self.confParse.get(
                    setting, "MSMSfilter"
                )
            else:
            ...
            if self.confParse.has_option(setting, "selectionWindow"):
                self.optsImport["selectionWindow"] = self.confParse.get(
                    setting, "selectionWindow"
                )
            else:
                self.optsImport["selectionWindow"] = ""

            if self.confParse.has_option(setting, "precursorMassShift"):
                self.optsImport["precursorMassShift"] = self.confParse.get(
                    setting, "precursorMassShift"
                )
            else:
                self.optsImport["precursorMassShift"] = ""

            if self.confParse.has_option(setting, "precursorMassShiftOrbi"):
                self.optsImport["precursorMassShiftOrbi"] = self.confParse.get(
                    setting, "precursorMassShiftOrbi"
                )
            else:
    ...
    def getMasterScanInfo(self):
        ...
        MSthresholdType = ""
        MSMSthresholdType = ""
        if masterscan.options["MSthresholdType"] == "relative":
            MSthresholdType = "%"
        if masterscan.options["MSMSthresholdType"] == "relative":
            MSMSthresholdType = "%"
        ...
        strOut += "<tr><td>time range:</td><td>(%s, %s)</td></tr>\n" % (
            repr(masterscan.options["timerange"][0]),
            repr(masterscan.options["timerange"][1]),
        )
        strOut += "<tr><td>MS m/z range:</td><td>(%s, %s)</td></tr>\n" % (
            repr(masterscan.options["MSmassrange"][0]),
            repr(masterscan.options["MSmassrange"][1]),
        )
        strOut += "<tr><td>MS/MS m/z range:</td><td>(%s, %s)</td></tr>\n" % (
            repr(masterscan.options["MSMSmassrange"][0]),
            repr(masterscan.options["MSMSmassrange"][1]),
        )
    ...
    def __set_properties(self):
        ...
        self.text_ctrl_mstools_InputSection_mz.SetMinSize(
            (textCtrl_small_w - 20, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_sumComposition.SetMinSize(
            (textCtrl_big_w - 120, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_doubleBond_1.SetMinSize(
            (textCtrl_small_w - 60, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_doubleBond_2.SetMinSize(
            (textCtrl_small_w - 60, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_charge.SetMinSize(
            (textCtrl_small_w - 60, textCtrl_small_h)
        )
        ...
        self.text_ctrl_mstools_InputSection_sumComposition.SetMaxSize(
            (textCtrl_big_w - 120, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_doubleBond_1.SetMaxSize(
            (textCtrl_small_w - 60, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_doubleBond_2.SetMaxSize(
            (textCtrl_small_w - 60, textCtrl_small_h)
        )
        self.text_ctrl_mstools_InputSection_charge.SetMaxSize(
            (textCtrl_small_w - 60, textCtrl_small_h)
        )
        ...
        self.text_ctrl_SettingsSection_precursorMassShift.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_precursorMassShiftOrbi.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_precursorMassShiftOrbi.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_selectionWindow.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_selectionWindow.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_timerange1.SetMinSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_timerange2.SetMinSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_timerange1.SetMaxSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_timerange2.SetMaxSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_ms1.SetMinSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_ms2.SetMinSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_ms1.SetMaxSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_ms2.SetMaxSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_msms1.SetMinSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_msms2.SetMinSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_msms1.SetMaxSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_massrange_msms2.SetMaxSize(
            (textCtrl_small_w / 2 - 5, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resolution_ms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resolution_ms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resolution_msms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resolution_msms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_tolerance_ms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_tolerance_ms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_tolerance_msms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_tolerance_msms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_threshold_ms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_threshold_ms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_threshold_msms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_threshold_msms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_occupationThr_ms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_occupationThr_ms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_occupationThr_msms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_occupationThr_msms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resDelta_ms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resDelta_ms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resDelta_msms.SetMinSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_resDelta_msms.SetMaxSize(
            (textCtrl_small_w, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_calibration_ms.SetMinSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_calibration_ms.SetMaxSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_calibration_msms.SetMinSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_calibration_msms.SetMaxSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )

        self.text_ctrl_SettingsSection_filter_ms.SetMinSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_filter_ms.SetMaxSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_filter_msms.SetMinSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )
        self.text_ctrl_SettingsSection_filter_msms.SetMaxSize(
            (textCtrl_small_w * 2, textCtrl_small_h)
        )

        self.text_ctrl_mstools_OutputSection.SetMinSize(
            (textCtrl_big_w, textCtrl_big_h * 3)
        )
        self.text_ctrl_mstools_OutputSection.SetMaxSize(
            (textCtrl_big_w * 2, textCtrl_big_h * 3)
        )
        self.text_ctrl_mstools_Isotopes_output.SetMinSize(
            (textCtrl_big_w, textCtrl_big_h * 6)
        )
        self.text_ctrl_mstools_Isotopes_output.SetMaxSize(
            (textCtrl_big_w * 2, textCtrl_big_h * 6)
        )
    ...
    def __do_layout(self):
        ...
        sizer_toolPane.Add(
            self.label_mstools_InputSection, 0, wx.ALIGN_LEFT | wx.ALL, 10
        )
        ...
        sizer_toolPane_4.Add(
            self.label_mstools_InputSection_sumComposition,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_4.Add(
            self.text_ctrl_mstools_InputSection_sumComposition,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_8 = wx.BoxSizer(wx.VERTICAL)
        sizer_toolPane_8.Add(
            self.label_mstools_InputSection_doubleBond_1,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_8.Add(
            self.text_ctrl_mstools_InputSection_doubleBond_1,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_9 = wx.BoxSizer(wx.VERTICAL)
        sizer_toolPane_9.Add(
            self.label_mstools_InputSection_doubleBond_2,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_9.Add(
            self.text_ctrl_mstools_InputSection_doubleBond_2,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_6 = wx.BoxSizer(wx.VERTICAL)
        sizer_toolPane_6.Add(
            self.label_mstools_InputSection_charge,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_6.Add(
            self.text_ctrl_mstools_InputSection_charge,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_5 = wx.BoxSizer(wx.VERTICAL)
        sizer_toolPane_5.Add(
            self.label_mstools_InputSection_accuracy,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_5.Add(
            self.text_ctrl_mstools_InputSection_accuracy,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_7 = wx.BoxSizer(wx.VERTICAL)
        sizer_toolPane_7.Add(
            self.label_mstools_InputSection_accuracy_blank,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_7.Add(
            self.label_mstools_InputSection_accuracy_ppm,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        ...
        sizer_toolPane_1.Add(
            self.button_massToSumComposition, 0, wx.ALIGN_LEFT | wx.ALL, 10
        )
        sizer_toolPane_1.Add(
            self.button_sumCompositionToMass, 0, wx.ALIGN_LEFT | wx.ALL, 10
        )
        ...
        sizer_toolPane_10.Add(
            self.text_ctrl_mstools_Isotopes_precursor,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_11 = wx.BoxSizer(wx.VERTICAL)
        sizer_toolPane_11.Add(
            self.label_mstools_Isotopes_fragment,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        sizer_toolPane_11.Add(
            self.text_ctrl_mstools_Isotopes_fragment,
            0,
            wx.ALIGN_LEFT | wx.EXPAND | wx.ALL,
            5,
        )
        ...
        grid_sizer_5_listBox.Add(
            self.button_AddMFQL, (1, 1), wx.DefaultSpan, wx.ALL | wx.EXPAND, 2
        )
        grid_sizer_5_listBox.Add(
            self.button_AddDir, (2, 1), wx.DefaultSpan, wx.ALL | wx.EXPAND, 2
        )
        grid_sizer_5_listBox.Add(
            self.button_OpenFile, (3, 1), wx.DefaultSpan, wx.ALL | wx.EXPAND, 2
        )
        grid_sizer_5_listBox.Add(
            self.button_NewFile, (4, 1), wx.DefaultSpan, wx.ALL | wx.EXPAND, 2
        )
        grid_sizer_5_listBox.Add(
            self.button_RemoveEntry, (5, 1), wx.DefaultSpan, wx.ALL, 2
        )
        ...
        grid_sizer_1_RunCard.Add((10, 10))
        grid_sizer_1_RunCard.Add(
            self.label_MasterScanSection, 0, wx.LEFT, border_labels
        )
        ...
        grid_sizer_29_OptionsSection.Add(
            self.label_RunOptions_tolerance,
            (0, 0),
            wx.DefaultSpan,
            wx.ALL | wx.EXPAND,
            2,
        ...
        grid_sizer_29_OptionsSection.Add(
            self.choice_RunOptions_MSMS_type,
            (0, 6),
            wx.DefaultSpan,
            wx.ALL | wx.EXPAND,
            2,
        ...
        grid_sizer_1_RunCard.Add(
            grid_sizer_29_OptionsSection, 0, wx.LEFT | wx.EXPAND, 10
        )
        ...
        grid_sizer_13_DumpSection.Add(
            self.button_Open_DumpSection, 0, wx.ALL | wx.EXPAND, 5
        )
        grid_sizer_26_OptionsSection.Add(
            grid_sizer_13_DumpSection, 0, wx.LEFT | wx.EXPAND, 10
        )
        grid_sizer_25_OptionsSection = wx.BoxSizer(wx.VERTICAL)
        grid_sizer_25_OptionsSection.Add(
            self.checkBox_OptionsSection_nohead, 0, wx.LEFT | wx.EXPAND, 10
        )
        grid_sizer_25_OptionsSection.Add(
            self.checkBox_OptionsSection_compress, 0, wx.LEFT | wx.EXPAND, 10
        )
        grid_sizer_25_OptionsSection.Add(
            self.checkBox_OptionsSection_tabLimited, 0, wx.LEFT | wx.EXPAND, 10
        )
        grid_sizer_31_OptionsSection = wx.BoxSizer(wx.VERTICAL)
        grid_sizer_31_OptionsSection.Add(
            self.checkBox_generateStatistics, 0, wx.LEFT | wx.EXPAND, 10
        )
        grid_sizer_31_OptionsSection.Add(
        ...
        grid_sizer_2_RunCard_0.Add(
            grid_sizer_2_RunCard,
            0,
            wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL,
            0,
        )
        ...
        grid_sizer_2_RunCard.Add(
            self.label_ImportDataSection, 0, wx.LEFT, border_labels
        )
        grid_sizer_14_textBrowse_V = wx.BoxSizer(wx.VERTICAL)
        grid_sizer_15_ImportDataSection = wx.BoxSizer(wx.HORIZONTAL)
        grid_sizer_15_ImportDataSection.Add(
            self.text_ctrl_ImportDataSection, 0, wx.ALL, 10
        )
        grid_sizer_15_ImportDataSection.Add(
            self.button_Browse_ImportDataSection, 0, wx.ALL, 5
        )
        grid_sizer_15_ImportDataSection.Add(
            self.combo_ctrl_ImportDataSection, 0, wx.ALL, 5
        )
        ...
        grid_sizer_30_ImportDataSection_pisSpectra.Add(
            self.checkBox_importMSMS, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        grid_sizer_30_ImportDataSection_pisSpectra.Add(
            self.checkBox_pisSpectra, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5
        )
        grid_sizer_30_ImportDataSection_GroupSamples.Add(
            grid_sizer_30_ImportDataSection_pisSpectra, 0, wx.EXPAND, 0
        )
        grid_sizer_30_ImportDataSection_GroupSamples.Add(
        ...
        grid_sizer_2_RunCard.Add(
            self.label_OutputMasterScanSection, 0, wx.LEFT, border_labels
        )
        grid_sizer_21_textBrowse_V = wx.BoxSizer(wx.VERTICAL)
        grid_sizer_22_OutputMasterScanSection = wx.BoxSizer(wx.HORIZONTAL)
        grid_sizer_22_OutputMasterScanSection.Add(
            self.text_ctrl_OutputMasterScanSection, 0, wx.ALL, 10
        )
        grid_sizer_22_OutputMasterScanSection.Add(
            self.button_Browse_OutputMasterScanSection, 0, wx.ALL, 5
        )
        grid_sizer_21_textBrowse_V.Add(
            grid_sizer_22_OutputMasterScanSection, 1, wx.EXPAND, 0
        )
        ...
        box_sizer_ImportSettings.Add(
            self.label_LoadIniSection, 0, wx.LEFT, border_labels
        )
        ...
        box_sizer_ImportSettings.Add(
            self.static_line_LoadIniSection, 0, wx.ALIGN_CENTER_HORIZONTAL, 20
        )
        box_sizer_ImportSettings.Add((10, 10))

        # set settings
        box_sizer_ImportSettings.Add(
            self.label_SelectSettingSection, 0, wx.LEFT, border_labels
        )
        box_sizer_ImportSettings.Add((10, 10))
        box_sizer_ImportSettings_SelectConfiguration = wx.BoxSizer(wx.VERTICAL)
        box_sizer_ImportSettings_SelectConfiguration.Add(
            self.choice_SelectSettingSection, 0, wx.LEFT, 20
        )
        box_sizer_ImportSettings.Add(
            box_sizer_ImportSettings_SelectConfiguration,
            0,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_selectionWindow,
            (0, 1),
            wx.DefaultSpan,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_selectionWindow_unit,
            (0, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_timerange,
            (1, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_timerange_unit,
            (1, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_calibration,
            (2, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_calibration_ms,
            (2, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.text_ctrl_SettingsSection_calibration_ms,
            (2, 4),
            (1, 2),
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_calibration_msms,
            (2, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.text_ctrl_SettingsSection_calibration_msms,
            (2, 7),
            (1, 2),
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_massrange_ms,
            (3, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_massrange_ms_unit,
            (3, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_massrange_msms,
            (3, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_massrange_msms_unit,
            (3, 8),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resolution,
            (4, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resolution_ms,
            (4, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resolution_ms_unit,
            (4, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resolution_msms,
            (4, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resolution_msms_unit,
            (4, 8),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_tolerance,
            (5, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_tolerance_ms,
            (5, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_tolerance_msms,
            (5, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_threshold,
            (6, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_threshold_ms,
            (6, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_threshold_msms,
            (6, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resDelta,
            (7, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resDelta_ms,
            (7, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resDelta_ms_unit,
            (7, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resDelta_msms,
            (7, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_resDelta_msms_unit,
            (7, 8),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_occupationThr,
            (8, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_occupationThr_ms,
            (8, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_occupationThr_ms_unit,
            (8, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_occupationThr_msms,
            (8, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_occupationThr_msms_unit,
            (8, 8),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_precursorMassShift,
            (10, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.text_ctrl_SettingsSection_precursorMassShift,
            (10, 4),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_precursorMassShift_unit,
            (10, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.text_ctrl_SettingsSection_filter_ms,
            (9, 4),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_filter_ms,
            (9, 3),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_filter_ms_unit,
            (9, 5),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.text_ctrl_SettingsSection_filter_msms,
            (9, 7),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_filter_msms,
            (9, 1),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_filter_ms_ms,
            (9, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_filter_msms_unit,
            (9, 8),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_precursorMassShiftOrbi,
            (10, 6),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.text_ctrl_SettingsSection_precursorMassShiftOrbi,
            (10, 7),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        grid_sizer_19_SettingsSection_gridBag.Add(
            self.label_SettingsSection_precursorMassShiftOrbi_unit,
            (10, 8),
            wx.DefaultSpan,
            wx.LEFT | wx.TOP | wx.EXPAND,
            sizeBorder,
        ...
        box_sizer_ImportSettings.Add(
            grid_sizer_20_RunButton, 0, wx.ALIGN_CENTER_HORIZONTAL, 0
        )
        ...
        dropTargetProject = GeneralFileDrawerDropTarget(
            self.notebook_1_pane_2, self.loadProject, "lxp"
        )
