...
a = Analysis(['LipidXplorer.py'],
             ...
             datas=[
                 ...
                 ('..\\venv\\Lib\\site-packages\\ms_deisotope\\_c\\*.pyd', 'ms_deisotope\\_c'),
                 ('..\\venv\\Lib\\site-packages\\ms_peak_picker\\_c\\*.pyd', 'ms_peak_picker\\_c'),
                 ('..\\venv\\Lib\\site-packages\\brainpy\\_c\\*.pyd', 'brainpy\\_c'),
