...
class MyFrame1(wx.Frame):
    def __init__(self, parent):
        ...
        bSizer2.Add(
            self.m_filePicker1, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5
        )
        ...
        bSizer3.Add(
            self.m_searchCtrl2, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5
        )

        self.m_button_sub = wx.Button(
            self, wx.ID_ANY, "sub", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button1 = wx.Button(
            self, wx.ID_ANY, "add all", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_listBox2 = wx.ListBox(
            ...
            wx.DefaultSize,
            m_listBox2Choices,
            wx.LB_EXTENDED | wx.LB_NEEDED_SB,
        )
        ...
        self.m_searchCtrl2.Bind(
            wx.EVT_SEARCHCTRL_SEARCH_BTN, self.toggleSearch
        )
