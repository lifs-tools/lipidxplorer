...
class simtrim_Frame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Simtrim", pos = wx.DefaultPosition, size = wx.Size( 500,239 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText26 = wx.StaticText( self, wx.ID_ANY, u"trim the sims from a spectra\n", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText18 = wx.StaticText( self, wx.ID_ANY, u"Spectra File with sims", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_filePicker10 = wx.FilePickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"Select a files", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE|wx.FLP_FILE_MUST_EXIST|wx.FLP_OPEN )
		bSizer35.Add( self.m_filePicker10, 1, wx.ALL|wx.EXPAND, 5 )


		fgSizer5.Add( bSizer35, 1, wx.EXPAND, 5 )

		self.m_staticText20 = wx.StaticText( self, wx.ID_ANY, u"custom dalton size to trim", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText30 = wx.StaticText( self, wx.ID_ANY, u"0 for automatic", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText22 = wx.StaticText( self, wx.ID_ANY, u"Retention Time", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText23 = wx.StaticText( self, wx.ID_ANY, u"Start", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText231 = wx.StaticText( self, wx.ID_ANY, u"end", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText231.Wrap( -1 )

		self.m_staticText231.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
		...
		self.run = wx.Button( self, wx.ID_ANY, u"run", wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
